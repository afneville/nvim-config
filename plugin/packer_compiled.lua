...
_G.packer_plugins = {
  ...
  ["cmp-omni"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/cmp-omni",
  ...
  ["oceanic-next"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/oceanic-next",
  ...
  ["tex-conceal.vim"] = {
    loaded = true,
    path = "/home/alex/.local/share/nvim/site/pack/packer/start/tex-conceal.vim",
