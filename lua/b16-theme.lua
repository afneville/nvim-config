...
function M.setup(colors, config)
    ...
    M.colors = colors or M.colorschemes[vim.env.BASE16_THEME] or M.colorschemes['dark']
    ...
    -- Custom
    hi.BufferLineFill              = { guifg = nil, guibg = M.colors.base01, gui = 'none', guisp = nil }
    hi.BufferLineBackground        = { guifg = M.colors.base03, guibg = M.colors.base01, gui = 'bold,italic', guisp = nil }
    hi.BufferLineBufferVisible     = { guifg = M.colors.base05, guibg = M.colors.base02, gui = 'bold', guisp = nil }
    hi.BufferLineBufferSelected    = { guifg = M.colors.base05, guibg = M.colors.base02, gui = 'bold', guisp = nil }
    hi.BufferLineIndicatorSelected = { guifg = M.colors.base02, guibg = M.colors.base02, gui = 'none', guisp = nil }
    hi.BufferLineIndicatorVisible  = { guifg = M.colors.base02, guibg = M.colors.base02, gui = 'none', guisp = nil }
    hi.BufferLineSeparator         = { guifg = M.colors.base02, guibg = M.colors.base01, gui = 'none', guisp = nil }
    hi.BufferLineSeparatorSelected = { guifg = M.colors.base02, guibg = M.colors.base01, gui = 'none', guisp = nil }
