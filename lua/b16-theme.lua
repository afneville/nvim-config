-- Shamelessly borrowed from https://github.com/RRethy/nvim-base16
...
local function hex_to_rgb(hex)
    return HEX_DIGITS[string.sub(hex, 1, 1)] * 16 + HEX_DIGITS[string.sub(
        hex,
        2,
        2
    )],
        HEX_DIGITS[string.sub(hex, 3, 3)] * 16 + HEX_DIGITS[string.sub(
            hex,
            4,
            4
        )],
        HEX_DIGITS[string.sub(hex, 5, 5)] * 16 + HEX_DIGITS[string.sub(
            hex,
            6,
            6
        )]
...
function M.setup(colors, config)
    ...
    M.colors = colors or M.colorschemes["default"]
    Colors = colors
    -- print("requiring lualine")
    ...
    hi.Directory =
        { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil }
    hi.Error = {
    ...
    hi.Exception =
        { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
    hi.FoldColumn = {
    ...
    hi.MatchParen =
        { guifg = nil, guibg = M.colors.base03, gui = nil, guisp = nil }
    hi.ModeMsg =
        { guifg = M.colors.base0B, guibg = nil, gui = nil, guisp = nil }
    hi.MoreMsg =
        { guifg = M.colors.base0B, guibg = nil, gui = nil, guisp = nil }
    hi.Question =
        { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil }
    ...
    hi.SpecialKey =
        { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.TooLong =
        { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
    hi.Underlined =
        { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
    ...
    hi.Title =
        { guifg = M.colors.base0D, guibg = nil, gui = "none", guisp = nil }
    hi.Conceal = {
    ...
    hi.NonText =
        { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.EndOfBuffer =
        { guifg = M.colors.base00, guibg = nil, gui = nil, guisp = nil }
    hi.LineNr = {
        guifg = M.colors.base03,
        guibg = M.colors.base00,
        gui = nil,
    ...
    hi.WinBar =
        { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
    hi.WinBarNC =
        { guifg = M.colors.base04, guibg = nil, gui = "none", guisp = nil }
    hi.VertSplit = {
        guifg = M.colors.base03,
        guibg = M.colors.base00,
        gui = "none",
    ...
    hi.ColorColumn =
        { guifg = nil, guibg = M.colors.base01, gui = "none", guisp = nil }
    hi.CursorColumn =
        { guifg = nil, guibg = M.colors.base01, gui = "none", guisp = nil }
    hi.CursorLine =
        { guifg = nil, guibg = M.colors.base01, gui = "none", guisp = nil }
    ...
    hi.QuickFixLine =
        { guifg = nil, guibg = M.colors.base01, gui = "none", guisp = nil }
    hi.PMenu =
        { guifg = nil, guibg = M.colors.base02, gui = "none", guisp = nil }
    hi.PMenuSbar =
        { guifg = nil, guibg = M.colors.base02, gui = "none", guisp = nil }
    hi.PMenuThumb =
        { guifg = nil, guibg = M.colors.base03, gui = "none", guisp = nil }
    hi.PMenuSel =
        { guifg = nil, guibg = M.colors.base03, gui = nil, guisp = nil }
    ...
    hi.Boolean =
        { guifg = M.colors.base09, guibg = nil, gui = nil, guisp = nil }
    hi.Character =
        { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
    hi.Comment =
        { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
    hi.Conditional =
        { guifg = M.colors.base0E, guibg = nil, gui = nil, guisp = nil }
    hi.Constant =
        { guifg = M.colors.base09, guibg = nil, gui = nil, guisp = nil }
    hi.Define =
        { guifg = M.colors.base0E, guibg = nil, gui = "none", guisp = nil }
    hi.Delimiter =
        { guifg = M.colors.base0F, guibg = nil, gui = nil, guisp = nil }
    hi.Float = { guifg = M.colors.base09, guibg = nil, gui = nil, guisp = nil }
    hi.Function =
        { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil }
    hi.Identifier =
        { guifg = M.colors.base08, guibg = nil, gui = "none", guisp = nil }
    hi.Include =
        { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil }
    hi.Keyword =
        { guifg = M.colors.base0E, guibg = nil, gui = nil, guisp = nil }
    ...
    hi.Operator =
        { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
    hi.PreProc =
        { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
    hi.Repeat = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
    hi.Special =
        { guifg = M.colors.base0C, guibg = nil, gui = nil, guisp = nil }
    hi.SpecialChar =
        { guifg = M.colors.base0F, guibg = nil, gui = nil, guisp = nil }
    hi.Statement =
        { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
    ...
    hi.Type =
        { guifg = M.colors.base0A, guibg = nil, gui = "none", guisp = nil }
    hi.Typedef =
        { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
    ...
    hi.gitcommitDiscardedType =
        { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil }
    hi.gitcommitBranch =
        { guifg = M.colors.base09, guibg = nil, gui = "bold", guisp = nil }
    hi.gitcommitUntrackedFile =
        { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
    hi.gitcommitUnmergedFile =
        { guifg = M.colors.base08, guibg = nil, gui = "bold", guisp = nil }
    hi.gitcommitDiscardedFile =
        { guifg = M.colors.base08, guibg = nil, gui = "bold", guisp = nil }
    hi.gitcommitSelectedFile =
        { guifg = M.colors.base0B, guibg = nil, gui = "bold", guisp = nil }
    ...
    hi.SpellBad =
        { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base08 }
    hi.SpellLocal =
        { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base0C }
    hi.SpellCap =
        { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base0D }
    hi.SpellRare =
        { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base0E }
    ...
    hi.DiagnosticUnderlineInformation =
        { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base0F }
    hi.DiagnosticUnderlineHint =
        { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base0C }

    hi.LspReferenceText =
        { guifg = nil, guibg = nil, gui = "underline", guisp = M.colors.base04 }
    hi.LspReferenceRead =
        { guifg = nil, guibg = nil, gui = "underline", guisp = M.colors.base04 }
    ...
    hi.TSAnnotation =
        { guifg = M.colors.base0F, guibg = nil, gui = "none", guisp = nil }
    hi.TSAttribute =
        { guifg = M.colors.base0A, guibg = nil, gui = "none", guisp = nil }
    hi.TSBoolean =
        { guifg = M.colors.base09, guibg = nil, gui = "none", guisp = nil }
    hi.TSCharacter =
        { guifg = M.colors.base08, guibg = nil, gui = "none", guisp = nil }
    hi.TSComment =
        { guifg = M.colors.base03, guibg = nil, gui = "italic", guisp = nil }
    hi.TSConstructor =
        { guifg = M.colors.base0D, guibg = nil, gui = "none", guisp = nil }
    hi.TSConditional =
        { guifg = M.colors.base0E, guibg = nil, gui = "none", guisp = nil }
    hi.TSConstant =
        { guifg = M.colors.base09, guibg = nil, gui = "none", guisp = nil }
    hi.TSConstBuiltin =
        { guifg = M.colors.base09, guibg = nil, gui = "italic", guisp = nil }
    hi.TSConstMacro =
        { guifg = M.colors.base08, guibg = nil, gui = "none", guisp = nil }
    hi.TSError =
        { guifg = M.colors.base08, guibg = nil, gui = "none", guisp = nil }
    ...
    hi.TSFunction =
        { guifg = M.colors.base0D, guibg = nil, gui = "none", guisp = nil }
    hi.TSFuncBuiltin =
        { guifg = M.colors.base0D, guibg = nil, gui = "italic", guisp = nil }
    hi.TSFuncMacro =
        { guifg = M.colors.base08, guibg = nil, gui = "none", guisp = nil }
    hi.TSInclude =
        { guifg = M.colors.base0D, guibg = nil, gui = "none", guisp = nil }
    ...
    hi.TSRepeat =
        { guifg = M.colors.base0E, guibg = nil, gui = "none", guisp = nil }
    hi.TSString =
        { guifg = M.colors.base0B, guibg = nil, gui = "none", guisp = nil }
    hi.TSStringRegex =
        { guifg = M.colors.base0C, guibg = nil, gui = "none", guisp = nil }
    hi.TSStringEscape =
        { guifg = M.colors.base0C, guibg = nil, gui = "none", guisp = nil }
    hi.TSSymbol =
        { guifg = M.colors.base0B, guibg = nil, gui = "none", guisp = nil }
    ...
    hi.TSEmphasis =
        { guifg = M.colors.base09, guibg = nil, gui = "italic", guisp = nil }
    hi.TSUnderline =
        { guifg = M.colors.base00, guibg = nil, gui = "underline", guisp = nil }
    hi.TSStrike = {
        guifg = M.colors.base00,
        guibg = nil,
        gui = "strikethrough",
    ...
    hi.TSLiteral =
        { guifg = M.colors.base09, guibg = nil, gui = "none", guisp = nil }
    hi.TSURI =
        { guifg = M.colors.base09, guibg = nil, gui = "underline", guisp = nil }
    hi.TSType =
        { guifg = M.colors.base0A, guibg = nil, gui = "none", guisp = nil }
    hi.TSTypeBuiltin =
        { guifg = M.colors.base0A, guibg = nil, gui = "italic", guisp = nil }
    hi.TSVariable =
        { guifg = M.colors.base08, guibg = nil, gui = "none", guisp = nil }
    hi.TSVariableBuiltin =
        { guifg = M.colors.base08, guibg = nil, gui = "italic", guisp = nil }
    ...
    hi.BufferLineErrorDiagnosticVisisble = {
        guifg = M.colors.base08,
        guibg = M.colors.base02,
        gui = "none",
        guisp = nil,
    ...
    hi.BufferLineWarningDiagnosticVisisble = {
        guifg = M.colors.base0A,
        guibg = M.colors.base02,
        gui = "none",
        guisp = nil,
    ...
    hi.NormalFloat =
        { guifg = nil, guibg = M.colors.base02, gui = nil, guisp = nil }
    hi.FloatBorder = {
        guifg = M.colors.base05,
        guibg = M.colors.base02,
        gui = nil,
    ...
    hi.TreesitterContext =
        { guifg = nil, guibg = M.colors.base01, gui = "italic", guisp = nil }
    ...
    if M.config.telescope then
        ...
        then
            ...
            hi.TelescopeBorder =
                { guifg = darkerbg, guibg = darkerbg, gui = nil, guisp = nil }
            hi.TelescopePromptBorder = {
                guifg = darkerstatusline,
                guibg = darkerstatusline,
                gui = nil,
                guisp = nil,
            }
            ...
            hi.TelescopeNormal =
                { guifg = nil, guibg = darkerbg, gui = nil, guisp = nil }
    ...
    if M.config.indentblankline then
        ...
        hi.IndentBlanklineContextChar =
            { guifg = M.colors.base04, gui = "nocombine" }
    end
    ...
    if M.config.cmp then
        ...
        hi.CmpItemAbbrMatch =
            { guifg = M.colors.base0D, guibg = M.colors.base02, guisp = nil }
        hi.CmpItemAbbrMatchFuzzy =
            { guifg = M.colors.base0D, guibg = M.colors.base02, guisp = nil }
        hi.CmpItemKindDefault =
            { guifg = M.colors.base05, guibg = M.colors.base02, guisp = nil }
        hi.CmpItemMenu = {
            guifg = M.colors.base04,
            guibg = M.colors.base02,
            gui = nil,
