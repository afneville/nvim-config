...
if Global.python.autoformat then table.insert(auto_formatters, python_autoformat) end
...
if Global.tsserver.autoformat then
...
if Global.lua.autoformat then table.insert(auto_formatters, lua_format) end

local json_format = {'BufWritePre', '*.json', 'lua vim.lsp.buf.formatting_sync(nil, 1000)'}
if Global.json.autoformat then table.insert(auto_formatters, json_format) end

local ruby_format = {'BufWritePre', '*.rb', 'lua vim.lsp.buf.formatting_sync(nil,1000)'}
if Global.ruby.autoformat then table.insert(auto_formatters, ruby_format) end

local go_format = {'BufWritePre', '*.go', 'lua vim.lsp.buf.formatting_sync(nil,1000)'}
if Global.go.autoformat then table.insert(auto_formatters, go_format) end
